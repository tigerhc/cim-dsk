 ...
 * @version V1.0
 * @package com.lmrj.dsk.eqplog.entity
 * @title: edc_dsk_log_production_defective实体
 * @description: edc_dsk_log_production_defective实体
 * @author: 高雪君
 * @date: 2020-12-30 10:10:00
 * @copyright: 2019 www.lmrj.com Inc. All rights reserved.
 */

@TableName("edc_dsk_log_production_defective")
@SuppressWarnings("serial")
@Data
public class EdcDskLogProductionDefective extends AbstractEntity {
