...
//            }
        ...
        oneReya.put("bay_id", "101A-12");
        oneReya.put("bay_index", "12");
        oneReya.put("bay_name", "二次热压");
        oneReya.put("run_time", 132);
        oneReya.put("toolg_id", "101A-12");
        oneReya.put("total_time", 132);
        oaryERes.add(twoReya);
        Map<String, Object> xRay = new HashMap<>();
        oneReya.put("bay_id", "101A-13");
        oneReya.put("bay_index", "13");
        oneReya.put("bay_name", "X射线");
        oneReya.put("run_time", 132);
        oneReya.put("toolg_id", "101A-13");
        oneReya.put("total_time", 132);
        oaryERes.add(xRay);
