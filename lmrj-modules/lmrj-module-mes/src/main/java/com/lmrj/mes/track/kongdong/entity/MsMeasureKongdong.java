...
@TableName("ms_measure_kongdong")
@SuppressWarnings("serial")
@Data
public class MsMeasureKongdong extends BaseDataEntity {
    ...
    /**晶圆ID*/
    @TableField(value = "void_ratio")
    @Excel(name = "空洞率", orderNum = "5", width = 20)
    ...
    @Excel(name = "类型", orderNum = "7", width = 20)
    private String type;
