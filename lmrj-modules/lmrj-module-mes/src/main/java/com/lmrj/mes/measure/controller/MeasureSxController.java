...
public class MeasureSxController {
    ...
    public Response findSxNumberExport(@RequestParam String productionName,@RequestParam String number,@RequestParam String startDate, @RequestParam String endDate, @RequestParam String type, @RequestParam String local){
        try {
            ...
            keyList.add(key4);
            ExcelExportEntity key5 = new ExcelExportEntity("1:A","5");
            keyList.add(key5);
            ExcelExportEntity key6 = new ExcelExportEntity("1:B","6");
            keyList.add(key6);
            ExcelExportEntity key7 = new ExcelExportEntity("1:C","7");
            keyList.add(key7);
            ExcelExportEntity key8 = new ExcelExportEntity("1:D","8");
            keyList.add(key8);
            ExcelExportEntity key9 = new ExcelExportEntity("2:A","9");
            keyList.add(key9);
            ExcelExportEntity key10 = new ExcelExportEntity("2:B","10");
            keyList.add(key10);
            ExcelExportEntity key11 = new ExcelExportEntity("2:C","11");
            keyList.add(key11);
            ExcelExportEntity key12 = new ExcelExportEntity("2:D","12");
            keyList.add(key12);
            ...
            for (int i = 0; i <size ; i++) {
                ...
                data.put("4","1");
                data.put("5",result.get(i).get("a1"));
                data.put("6",result.get(i).get("b1"));
                data.put("7",result.get(i).get("c1"));
                data.put("8",result.get(i).get("d1"));
                data.put("9",result.get(i).get("a2"));
                data.put("10",result.get(i).get("b2"));
                data.put("11",result.get(i).get("c2"));
                data.put("12",result.get(i).get("d2"));
                dataList.add(data);
                data = new HashMap<>() ;
                data.put("1",type);
                data.put("2",productionName);
                data.put("3",result.get(i).get("lotNo"));
                data.put("4","2");
                data.put("5",result2.get(i).get("a1"));
                data.put("6",result2.get(i).get("b1"));
                data.put("7",result2.get(i).get("c1"));
                data.put("8",result2.get(i).get("d1"));
                data.put("9",result2.get(i).get("a2"));
                data.put("10",result2.get(i).get("b2"));
                data.put("11",result2.get(i).get("c2"));
                data.put("12",result2.get(i).get("d2"));
                dataList.add(data);
            }

            Workbook book = ExcelExportUtil.exportExcel(new ExportParams("量测分离","量测详细信息"),keyList,dataList);
