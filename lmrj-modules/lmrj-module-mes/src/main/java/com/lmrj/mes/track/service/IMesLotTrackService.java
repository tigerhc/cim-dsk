...
public interface IMesLotTrackService extends ICommonService<MesLotTrack> {
    ...
    MesResult findApjParam(String eqpId,String methodName , String opId);
    ...
    MesLotTrack findNowLotByEqp(String eqpId);
    ...
    Map<String, Object> chartKongDong(String lineNo, String productionNo, String startDate, String endDate);
    ...
    String findSX(String production,String lotNo ,String flag);
