...
public class FabEquipmentStatusServiceImpl  extends CommonServiceImpl<FabEquipmentStatusMapper,FabEquipmentStatus> implements  IFabEquipmentStatusService {
    ...
    @Override
    public int updateYield(String eqpID, String lotNo, String recipeCode, int lotYield, int dayYield) {
        return baseMapper.updateYield(eqpID, lotNo, recipeCode, lotYield, dayYield);
    }
    @Override
