...
public class RmsRecipeTemplate extends BaseDataEntity {
    ...
    @Excel(name = "参数代码", orderNum = "1", width = 20)
    ...
    @Excel(name = "参数简称", orderNum = "1", width = 20)
    ...
    @Excel(name = "设定值", orderNum = "1", width = 20)
    ...
    @Excel(name = "是否首页显示", orderNum = "1", width = 20)
    private String showFlag;
    /**监控标记 N、不监控Y、监控*/
    @TableField(value = "monitor_flag")
    @Excel(name = "是否监控", orderNum = "1", width = 20)
    ...
    @Excel(name = "排序号", orderNum = "1", width = 20)
