...
public class RmsRecipe extends BaseDataEntity {
    ...
    @Excel(name = "配方CODE", orderNum = "2", width = 20)
    ...
    /**配方版本,DRAFT,EQP,GOLD*/
    @Excel(name = "程序等级", orderNum = "2", width = 20)
    @TableField(value = "version_type")
    private String versionType;
    /**配方版本号*/
    @TableField(value = "version_no")
    @Excel(name = "程序版本号", orderNum = "2", width = 20)
    ...
    @Excel(name = "审核状态", orderNum = "2", width = 20)
    private String approveStep;
    @TableField(value = "approve_result")
    @Excel(name = "审核结果", orderNum = "2", width = 20)
