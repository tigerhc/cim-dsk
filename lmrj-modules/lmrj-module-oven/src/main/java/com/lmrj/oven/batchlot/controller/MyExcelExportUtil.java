...
public class MyExcelExportUtil {
     ...
     *            Excel对象数据List
     */
    public static Workbook exportExcel(ExportParams entity, List<ExcelExportEntity> entityList, Collection<?> dataSet, int titleRows) {
        Workbook workbook = getWorkbook(entity.getType(),dataSet.size());;
        new MyExcelExportService().createSheetForMap(workbook, entity, entityList, dataSet, titleRows);
        return workbook;
    }
