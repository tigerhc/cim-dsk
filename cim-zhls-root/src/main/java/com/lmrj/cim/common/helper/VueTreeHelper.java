package com.lmrj.cim.common.helper;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.serializer.SerializeFilter;
import com.lmrj.common.mvc.entity.tree.TreeNode;
import com.lmrj.util.lang.ObjectUtil;
import com.lmrj.common.utils.fastjson.FastjsonPropertyPreFilter;
...
public class VueTreeHelper<ID extends Serializable> implements Serializable {
    ...
    private List<VueTreeNode> getTopNodes(String fields) {
        ...
        for (TreeNode treeable : treeNodes) {
            if (treeable.isRoot()) {
    ...
    private void parseSubNode(VueTreeNode node,String fields) {
        ...
        for (TreeNode treeable : treeNodes) {
            if (!ObjectUtil.isNullOrEmpty(treeable.getParentId()) && treeable.getParentId().equals(node.getNodeId())) {
    ...
    public List<VueTreeNode> sort(List<?> treeNodes, String fields) {
        this.treeNodes = (List<TreeNode>) treeNodes;
